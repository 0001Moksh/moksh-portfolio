  ...
  return (
    ...
    >
      <div>
        ...
        <span>
        B.Tech in Artificial Intelligence & Machine Learning MDU UNIVERCITY, 2027
        Zoho Developer Certification Zoho Corp, 2024
        Machine Learning & Deep Learning Specialization QunatumDev, 2025
        </span>
        <br />
        <br />
        <h1 className="text-cyan-600 font-semibold text-xl">
        ...
        <span>
            ...
            Automation & Integration: Zapier, APIs, Webhook
        </span>
        <br />
        <br />
        <h1 className="text-cyan-600 font-semibold text-xl">
        ...
        Conducted online training for corporate professionals on Excel, Power BI, and data visualization.
        </span>
        <br />
        <br />
        <h1 className="text-cyan-600 font-semibold text-xl">
        ...
        <p>
        My mission is to leverage AI and automation to develop efficient, scalable, and user-friendly solutions. I am committed to continuous learning, innovation, and helping businesses optimize their workflows with Zoho and AI.
        </p>
      </div>
      <br />
      <br /><hr />
